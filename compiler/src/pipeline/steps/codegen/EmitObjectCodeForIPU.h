...
class EmitObjectCodeForIPU
    : public StepDualInput<EmitObjectCodeForIPU<SourceType>, File<SourceType>,
...
public:
  using StepDualInput<EmitObjectCodeForIPU, File<SourceType>,
                      CompiledGraphProgram>::StepDualInput;

  ExecutionResult executeStep(File<SourceType> *source,
                              CompiledGraphProgram *file);

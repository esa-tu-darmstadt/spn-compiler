...
class vecSetter : public BaseVisitor {
public:
  vecSetter(std::vector<size_t> &Sum_, std::vector<size_t> &WeightedSum_, std::vector<size_t> &Product_ )

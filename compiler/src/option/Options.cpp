...
llvm::cl::opt<TargetMachine> compilationTarget{"spnc-target",
...
llvm::cl::opt<std::string> searchPaths{"spnc-search-paths", llvm::cl::desc("Additional search paths for libraries"),
                                       llvm::cl::init(""), llvm::cl::cat(compilationGroup)};

llvm::cl::opt<bool> deleteTemporaryFiles{"spnc-delete-temps",
                                         llvm::cl::desc("Delete temporary files after compilation"),
                                         llvm::cl::init(true), llvm::cl::cat(compilationGroup)};

llvm::cl::opt<bool> dumpIR{"spnc-dump-ir", llvm::cl::desc("Dump IR after individual steps and passes"),
                           llvm::cl::init(false), llvm::cl::cat(compilationGroup)};

llvm::cl::opt<bool> optRepresentation{
    "spnc-opt-repr",
    llvm::cl::desc("Enable whether an optimal representation for SPN evaluation should be "
                   "determined."),
    llvm::cl::init(false), llvm::cl::cat(compilationGroup)};

llvm::cl::opt<std::string> stopAfter{"spnc-stop-after", llvm::cl::desc("Stop after the specified step in the pipeline"),
                                     llvm::cl::init(""), llvm::cl::cat(compilationGroup)};
...
llvm::cl::opt<int> optLevel{"spnc-opt-level", llvm::cl::desc("Set the overall optimization level (0-3)"),
                            llvm::cl::init(3), llvm::cl::cat(optimizationGroup)};

llvm::cl::opt<int> irOptLevel{"spnc-irOptLevel",
                              llvm::cl::desc("Set the IR optimization level (0-3), overriding the general "
                                             "optimization level"),
                              llvm::cl::cat(optimizationGroup)};

llvm::cl::opt<int> mcOptLevel{"spnc-mcOptLevel",
                              llvm::cl::desc("Set the machine code optimization level (0-3), overriding the "
                                             "general optimization level"),
                              llvm::cl::cat(optimizationGroup)};

llvm::cl::opt<bool> logSpace{"spnc-use-log-space",
                             llvm::cl::desc("Enable log-space computation for numerical stability"),
                             llvm::cl::init(false)};

llvm::cl::opt<bool> gpuSharedMem{
    "spnc-gpu-shared-mem", llvm::cl::desc("Use shared/workgroup memory for GPU computation"), llvm::cl::init(true)};
...
llvm::cl::opt<bool> collectGraphStats{"spnc-collect-graph-stats",
                                      llvm::cl::desc("Collect static graph statistics during compilation"),
                                      llvm::cl::init(false), llvm::cl::cat(statsCategory)};

llvm::cl::opt<std::string> graphStatsFile{"spnc-graph-stats-file",
...
llvm::cl::opt<VectorLibrary> vectorLibrary{
    "spnc-vector-library", llvm::cl::desc("Specify the vector library to use for vectorization"),
    llvm::cl::values(
        ...
        clEnumValN(VectorLibrary::SLEEF, "SLEEF", "SLEEF SIMD Library for Evaluating Elementary Functions"),
        clEnumValN(VectorLibrary::Darwin_libsystem_m, "Darwin_libsystem_m", "Darwin's libsystem_m vector functions"),
        clEnumValN(VectorLibrary::ArmPL, "ArmPL", "Arm Performance Libraries"),
        clEnumValN(VectorLibrary::AMDLIBM, "AMDLIBM", "AMD vector math library")),
    llvm::cl::init(VectorLibrary::NoLibrary), llvm::cl::cat(vectorizationCategory)};

llvm::cl::opt<unsigned> vectorWidth{"spnc-vector-width",
...
llvm::cl::opt<bool> vectorize{"spnc-cpu-vectorize", llvm::cl::desc("Enable vectorization for CPU target"),
                              llvm::cl::init(false), llvm::cl::cat(vectorizationCategory)};

llvm::cl::opt<bool> replaceGatherWithShuffle{"spnc-use-shuffle",
...
llvm::cl::opt<unsigned> slpMaxAttempts{"spnc-slp-max-attempts",
...
llvm::cl::opt<unsigned> slpMaxSuccessfulIterations{
    ...
    llvm::cl::init(1), llvm::cl::cat(slpCategory)};
llvm::cl::opt<unsigned> slpMaxNodeSize{"spnc-slp-max-node-size",
...
llvm::cl::opt<unsigned> slpMaxLookAhead{"spnc-slp-max-look-ahead",
...
llvm::cl::opt<bool> slpReorderInstructionsDFS{"spnc-slp-reorder-dfs",
...
llvm::cl::opt<bool> slpAllowDuplicateElements{"spnc-slp-allow-duplicate-elements",
...
llvm::cl::opt<bool> slpAllowTopologicalMixing{"spnc-slp-allow-topological-mixing",
                                              llvm::cl::desc("Flag to indicate if elements with different topological "
                                                             "depths are allowed in vectors during SLP graph "
                                                             "building"),
                                              llvm::cl::init(false), llvm::cl::cat(slpCategory)};
llvm::cl::opt<bool> slpUseXorChains{"spnc-slp-use-xor-chains",
...
llvm::cl::opt<int> maxTaskSize{"spnc-max-task-size", llvm::cl::desc("Maximum number of operations per task"),
                               llvm::cl::init(-1), llvm::cl::cat(partitionCategory)};
...
llvm::cl::opt<IPUTarget> ipuTarget{"spnc-ipu-target", llvm::cl::desc("Specify the IPU target"),
...
llvm::cl::opt<std::string> ipuCompilerPath{"spnc-ipu-compiler-path",

...
module {
  func @spn_kernel_body(%arg0: i32, %arg1: i32) -> f64 {
    ...
    %5 = "spn.sum"(%0, %1, %2, %3, %4) {opCount = 5 : ui32} : (f64, f64, f64, f64, f64) -> f64
    "spn.return"(%5) : (f64) -> ()
  }
}

//  N-ary sums will be converted into a sequence of N-1 "addf" insn.
//  This test uses histograms as "non-const" f64 values. We make sure that each
//  value / intermediate sum is used and the last sum is returned.

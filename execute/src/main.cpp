...
int main(int argc, char *argv[]) {
  ...
  // If the mini-example or the categorical-example is fed to the compiler, the
  // compiled kernel can be executed using the following lines of code. The
  // expected results for mini-example are -1.44445 -2.65748 -0.670163 -1.70169

module {
  ...
  ^bb0(%arg0: tensor<?x5xi32>):
    %0 = "lo_spn.task"(%arg0) ({
    ^bb0(%arg1: index, %arg2: tensor<?x5xi32>):
      %1 = "lo_spn.batch_extract"(%arg2, %arg1) {staticIndex = 0 : ui32, transposed = false} : (tensor<?x5xi32>, index) -> i32
      %2 = "lo_spn.batch_extract"(%arg2, %arg1) {staticIndex = 1 : ui32, transposed = false} : (tensor<?x5xi32>, index) -> i32
      %3 = "lo_spn.batch_extract"(%arg2, %arg1) {staticIndex = 2 : ui32, transposed = false} : (tensor<?x5xi32>, index) -> i32
      %4 = "lo_spn.batch_extract"(%arg2, %arg1) {staticIndex = 3 : ui32, transposed = false} : (tensor<?x5xi32>, index) -> i32
      %5 = "lo_spn.batch_extract"(%arg2, %arg1) {staticIndex = 4 : ui32, transposed = false} : (tensor<?x5xi32>, index) -> i32
  ...
  }) {function_type = (tensor<?x5xi32>) -> tensor<1x?xf64>, sym_name = "spn_kernel"} : () -> ()
}

// RUN: %optcall --copy-removal %s | FileCheck %s
...
module  {
  ...
  func @spn_kernel(%arg0: memref<?x2xi32>, %arg1: memref<?xf64>) {
    ...
    linalg.copy(%1, %arg1) : memref<?xf64>, memref<?xf64>
    dealloc %1 : memref<?xf64>
    return
  }
}
...
// CHECK:           call @task_0(%[[VAL_0]], %[[VAL_1]]) : (memref<?x2xi32>, memref<?xf64>) -> ()
// CHECK:           return
// CHECK:         }

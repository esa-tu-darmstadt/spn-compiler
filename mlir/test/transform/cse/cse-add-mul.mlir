  ...
  ^bb0(%arg0: memref<?x2xf64>, %arg1: memref<1x?xf64>):  // no predecessors
    ...
    ^bb0(%arg2: index, %arg3: memref<?x2xf64>, %arg4: memref<1x?xf64>):  // no predecessors
      ...
      ^bb0(%arg5: f64, %arg6: f64):  // no predecessors
        %20 = "lo_spn.constant"() {type = f64, value = 4.2e+00 : f64} : () -> f64
        %21 = "lo_spn.mul"(%arg5, %20) : (f64, f64) -> f64
        %22 = "lo_spn.add"(%arg6, %21) : (f64, f64) -> f64
        %23 = "lo_spn.constant"() {type = f64, value = 4.2e+00 : f64} : () -> f64
        %24 = "lo_spn.mul"(%23, %arg5) : (f64, f64) -> f64
        %25 = "lo_spn.add"(%arg6, %24) : (f64, f64) -> f64
    ...
    "lo_spn.return"() : () -> ()
  }) {sym_name = "spn_kernel", function_type = (memref<?x2xf64>, memref<1x?xf64>) -> ()} : () -> ()
}
...
// CHECK:             }) : (f64, f64) -> f64
// CHECK:             "lo_spn.batch_write"(%[[VAL_7]], %[[VAL_5]], %[[VAL_17:.*]]) {transposed = true} : (memref<1x?xf64>, index, f64) -> ()
// CHECK:             "lo_spn.return"() : () -> ()
// CHECK:           }) {batchSize = 1 : ui32} : (memref<?x2xf64>, memref<1x?xf64>) -> ()
// CHECK:           "lo_spn.copy"(%[[VAL_4]], %[[VAL_1]]) : (memref<1x?xf64>, memref<1x?xf64>) -> ()
// CHECK:           "lo_spn.return"() : () -> ()
// CHECK:         }) {function_type = (memref<?x2xf64>, memref<1x?xf64>) -> (), sym_name = "spn_kernel"} : () -> ()

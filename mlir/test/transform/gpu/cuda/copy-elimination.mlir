...
module  {
  func.func @spn_gpu(%arg0: memref<?x5xi32>, %arg1: memref<1x?xf64>) {
    ...
    gpu.launch blocks(%arg2, %arg3, %arg4) in (%arg8 = %11, %arg9 = %c1_12, %arg10 = %c1_12) threads(%arg5, %arg6, %arg7) in (%arg11 = %c64_11, %arg12 = %c1_12, %arg13 = %c1_12) {
      %17 = arith.muli %c64_11, %arg2 : index
      %18 = arith.addi %17, %arg5 : index
    ...
    gpu.launch blocks(%arg2, %arg3, %arg4) in (%arg8 = %16, %arg9 = %c1_21, %arg10 = %c1_21) threads(%arg5, %arg6, %arg7) in (%arg11 = %c64_20, %arg12 = %c1_21, %arg13 = %c1_21) {
      %17 = arith.muli %c64_20, %arg2 : index
      %18 = arith.addi %17, %arg5 : index
      ...
      scf.if %19 {
        ...
        %cst_22 = arith.constant 0.19583333333333333 : f64
...
// CHECK:           gpu.func.func @spn_gpu_kernel(%[[VAL_0:.*]]: index, %[[VAL_1:.*]]: memref<?x5xi32>, %[[VAL_2:.*]]: memref<2x?xf64>) kernel {
...
// CHECK:             %[[VAL_16:.*]] = arith.muli %[[VAL_3]], %[[VAL_15]] : index
// CHECK:             %[[VAL_17:.*]] = arith.addi %[[VAL_16]], %[[VAL_6]] : index
...
// CHECK:           gpu.func.func @spn_gpu_kernel(%[[VAL_0:.*]]: index, %[[VAL_1:.*]]: memref<2x?xf64>, %[[VAL_2:.*]]: memref<?x5xi32>, %[[VAL_3:.*]]: memref<2x?xf64>) kernel {
...
// CHECK:             %[[VAL_17:.*]] = arith.muli %[[VAL_4]], %[[VAL_16]] : index
...
// CHECK:           gpu.func.func @spn_gpu_kernel(%[[VAL_0:.*]]: index, %[[VAL_1:.*]]: memref<2x?xf64>, %[[VAL_2:.*]]: memref<2x?xf64>, %[[VAL_3:.*]]: memref<1x?xf64>) kernel {
// CHECK:             %[[VAL_4:.*]] = "gpu.block_id"() <{dimension = "x"}> : () -> index
// CHECK:             %[[VAL_5:.*]] = "gpu.block_id"() <{dimension = "y"}> : () -> index
// CHECK:             %[[VAL_6:.*]] = "gpu.block_id"() <{dimension = "z"}> : () -> index
// CHECK:             %[[VAL_7:.*]] = "gpu.thread_id"() <{dimension = "x"}> : () -> index
...
// CHECK:           ^bb1:
// CHECK:             %[[VAL_16:.*]] = arith.constant 64 : index
// CHECK:             %[[VAL_17:.*]] = arith.constant 0.80416666666666669 : f64
// CHECK:             %[[VAL_18:.*]] = arith.constant 0.19583333333333333 : f64
// CHECK:             %[[VAL_19:.*]] = arith.muli %[[VAL_4]], %[[VAL_16]] : index

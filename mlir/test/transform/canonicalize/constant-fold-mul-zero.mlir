...
// CHECK:               %[[VAL_13:.*]] = "lo_spn.constant"() {type = f64, value = 0.000000e+00 : f64} : () -> f64
// CHECK:               "lo_spn.yield"(%[[VAL_13]]) : (f64) -> ()
// CHECK:             }) : (f64, f64) -> f64
// CHECK:             "lo_spn.batch_write"(%[[VAL_7]], %[[VAL_5]], %[[VAL_14:.*]]) {transposed = true} : (memref<1x?xf64>, index, f64) -> ()
// CHECK:             "lo_spn.return"() : () -> ()

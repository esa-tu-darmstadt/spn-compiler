  ...
  ^bb0(%arg0: memref<?x2xf64>, %arg1: memref<1x?xf64>):
    ...
    ^bb0(%arg2: index, %arg3: memref<?x2xf64>, %arg4: memref<1x?xf64>):
      ...
      ^bb0(%arg5: f64, %arg6: f64):
        ...
        %4 = "lo_spn.constant"() <{type = f64, value = 1.000000e+00 : f64}> : () -> f64
...
// CHECK:               %[[VAL_15:.*]] = "lo_spn.mul"(%[[VAL_11]], %[[VAL_12]]) : (f64, f64) -> f64
// CHECK:               %[[VAL_16:.*]] = "lo_spn.mul"(%[[VAL_14]], %[[VAL_13]]) : (f64, f64) -> f64

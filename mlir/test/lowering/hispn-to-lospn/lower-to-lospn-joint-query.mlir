...
module {
  "hi_spn.joint_query"() <{batchSize = 10 : ui32, errorModel = 1 : i32, featureDataType = i32, maxError = 2.000000e-02 : f64, numFeatures = 2 : ui32, queryName = "spn_kernel", supportMarginal = false}> ({
    "hi_spn.graph"() <{numFeatures = 2 : ui32}> ({

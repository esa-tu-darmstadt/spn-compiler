...
module {
  "hi_spn.joint_query"() <{batchSize = 12 : ui32, errorModel = 1 : i32, featureDataType = f64, maxError = 2.000000e-02 : f64, numFeatures = 1 : ui32, queryName = "spn_kernel", supportMarginal = false}> ({
...
// CHECK-LABEL:   "hi_spn.joint_query"() <{batchSize = 12 : ui32, errorModel = 1 : i32, featureDataType = f64, maxError = 2.000000e-02 : f64, numFeatures = 1 : ui32, queryName = "spn_kernel", supportMarginal = false}> ({

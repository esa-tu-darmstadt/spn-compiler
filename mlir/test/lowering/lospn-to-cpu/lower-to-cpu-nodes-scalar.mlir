...
module  {
  ...
  func.func @vec_task_0(%arg0: memref<?x6xf64>, %arg1: memref<1x?xf64>) {
    ...
    scf.for %arg2 = %c0_0 to %2 step %c4_1 {
      ...
      %5 = arith.muli %4, %cst_2 : vector<4xi64>
      %6 = arith.addi %5, %cst : vector<4xi64>
      ...
      %13 = arith.muli %12, %cst_8 : vector<4xi64>
      %14 = arith.addi %13, %cst_7 : vector<4xi64>
      ...
      %21 = arith.muli %20, %cst_15 : vector<4xi64>
      %22 = arith.addi %21, %cst_14 : vector<4xi64>
      ...
      %29 = arith.muli %28, %cst_22 : vector<4xi64>
      %30 = arith.addi %29, %cst_21 : vector<4xi64>
      ...
      %37 = arith.muli %36, %cst_29 : vector<4xi64>
      %38 = arith.addi %37, %cst_28 : vector<4xi64>
      ...
      %45 = arith.muli %44, %cst_36 : vector<4xi64>
      %46 = arith.addi %45, %cst_35 : vector<4xi64>
      ...
      %52 = arith.fptoui %10 : vector<4xf64> to vector<4xi64>
      ...
      %55 = arith.fptoui %18 : vector<4xf64> to vector<4xi64>
      ...
      %58 = arith.fptoui %26 : vector<4xf64> to vector<4xi64>
      ...
      %61 = arith.fptoui %34 : vector<4xf64> to vector<4xi64>
      ...
      %63 = arith.subf %42, %cst_56 : vector<4xf64>
      %64 = arith.mulf %63, %63 : vector<4xf64>
      %65 = arith.mulf %64, %cst_55 : vector<4xf64>
      %66 = math.exp %65 : vector<4xf64>
      %67 = arith.mulf %cst_54, %66 : vector<4xf64>
      ...
      %68 = arith.subf %50, %cst_59 : vector<4xf64>
      %69 = arith.mulf %68, %68 : vector<4xf64>
      %70 = arith.mulf %69, %cst_58 : vector<4xf64>
      %71 = math.exp %70 : vector<4xf64>
      %72 = arith.mulf %cst_57, %71 : vector<4xf64>
      %73 = arith.mulf %53, %56 : vector<4xf64>
      %74 = arith.mulf %73, %59 : vector<4xf64>
      %cst_60 = arith.constant dense<1.000000e-01> : vector<4xf64>
      %75 = arith.mulf %74, %cst_60 : vector<4xf64>
      %76 = arith.mulf %62, %67 : vector<4xf64>
      %77 = arith.mulf %76, %72 : vector<4xf64>
      %cst_61 = arith.constant dense<1.000000e-01> : vector<4xf64>
      %78 = arith.mulf %77, %cst_61 : vector<4xf64>
      %79 = arith.addf %75, %78 : vector<4xf64>
    ...
    scf.for %arg2 = %2 to %0 step %c1 {
      ...
      %11 = "lo_spn.histogram"(%5) {bucketCount = 2 : ui32, buckets = [#lo_spn.bucket<0, 1, 2.500000e-01>, #lo_spn.bucket<1, 2, 7.500000e-01>], supportMarginal = false} : (f64) -> f64
      %12 = "lo_spn.histogram"(%6) {bucketCount = 2 : ui32, buckets = [#lo_spn.bucket<0, 1, 4.500000e-01>, #lo_spn.bucket<1, 2, 5.500000e-01>], supportMarginal = false} : (f64) -> f64

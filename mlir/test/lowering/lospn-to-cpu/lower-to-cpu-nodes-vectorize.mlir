...
module  {
  func.func @vec_task_0(%arg0: memref<?x6xf64>, %arg1: memref<1x?xf64>) {
    ...
    scf.for %arg2 = %c0_0 to %2 step %c4_1 {
      ...
      %17 = "lo_spn.arith.constant"() {type = f64, value = 1.000000e-01 : f64, vector_width = 4 : i32} : () -> f64
      ...
      %21 = "lo_spn.arith.constant"() {type = f64, value = 1.000000e-01 : f64, vector_width = 4 : i32} : () -> f64
...
// CHECK-LABEL:   memref.global "private" arith.constant @histogram_vec_1 : memref<2xf64> = dense<[4.500000e-01, 5.500000e-01]>
...
// CHECK:             %[[VAL_167:.*]] = "lo_spn.arith.constant"() {type = f64, value = 1.000000e-01 : f64} : () -> f64
...
// CHECK:             %[[VAL_171:.*]] = "lo_spn.arith.constant"() {type = f64, value = 1.000000e-01 : f64} : () -> f64

  ...
  ^bb0(%arg0: memref<?x6xf64>, %arg1: memref<1x?xf64>):  // no predecessors
    ...
    ^bb0(%arg2: index, %arg3: memref<?x6xf64>, %arg4: memref<1x?xf64>):  // no predecessors
      ...
      ^bb0(%arg5: f64, %arg6: f64, %arg7: f64, %arg8: f64, %arg9: f64, %arg10: f64):  // no predecessors
        ...
        %23 = "lo_spn.arith.constant"() {type = f64, value = 1.000000e-01 : f64} : () -> f64
        %24 = "lo_spn.mul"(%18, %23) : (f64, f64) -> f64
        %19 = "lo_spn.mul"(%14, %15) : (f64, f64) -> f64
        %20 = "lo_spn.mul"(%19, %16) : (f64, f64) -> f64
        %25 = "lo_spn.arith.constant"() {type = f64, value = 1.000000e-01 : f64} : () -> f64
...
// CHECK:             %[[VAL_24:.*]] = "lo_spn.arith.constant"() {type = f64, value = 1.000000e-01 : f64, vector_width = 4 : i32} : () -> f64
...
// CHECK:             %[[VAL_28:.*]] = "lo_spn.arith.constant"() {type = f64, value = 1.000000e-01 : f64, vector_width = 4 : i32} : () -> f64
...
// CHECK:             %[[VAL_48:.*]] = "lo_spn.arith.constant"() {type = f64, value = 1.000000e-01 : f64} : () -> f64
...
// CHECK:             %[[VAL_52:.*]] = "lo_spn.arith.constant"() {type = f64, value = 1.000000e-01 : f64} : () -> f64

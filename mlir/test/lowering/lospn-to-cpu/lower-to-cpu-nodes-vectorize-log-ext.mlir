...
module  {
  func.func @vec_task_0(%arg0: memref<?x4xf32>, %arg1: memref<1x?xf64>) {
    ...
    scf.for %arg2 = %c0_0 to %2 step %c8_1 {
      ...
      %11 = "lo_spn.arith.constant"() {type = !lo_spn.log<f64>, value = -1.3862943611198906 : f64, vector_width = 4 : i32} : () -> !lo_spn.log<f64>
    ...
    scf.for %arg2 = %2 to %0 step %c1 {
      ...
      %11 = "lo_spn.arith.constant"() {type = !lo_spn.log<f64>, value = -1.3862943611198906 : f64} : () -> !lo_spn.log<f64>

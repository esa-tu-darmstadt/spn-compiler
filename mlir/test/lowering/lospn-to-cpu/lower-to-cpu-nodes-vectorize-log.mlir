...
module  {
  func.func @vec_task_0(%arg0: memref<?x6xf32>, %arg1: memref<1x?xf32>) {
    ...
    scf.for %arg2 = %c0_0 to %2 step %c4_1 {
      ...
      %17 = "lo_spn.arith.constant"() {type = !lo_spn.log<f32>, value = 1.000000e-01 : f64, vector_width = 8 : i32} : () -> !lo_spn.log<f32>
      ...
      %21 = "lo_spn.arith.constant"() {type = !lo_spn.log<f32>, value = 1.000000e-01 : f64, vector_width = 8 : i32} : () -> !lo_spn.log<f32>
...
// CHECK-LABEL:   memref.global "private" arith.constant @histogram_vec_1 : memref<2xf32> = dense<[-0.79850769, -0.597836971]>
...
// CHECK:             %[[VAL_170:.*]] = "lo_spn.arith.constant"() {type = !lo_spn.log<f32>, value = 1.000000e-01 : f64} : () -> !lo_spn.log<f32>
...
// CHECK:             %[[VAL_174:.*]] = "lo_spn.arith.constant"() {type = !lo_spn.log<f32>, value = 1.000000e-01 : f64} : () -> !lo_spn.log<f32>

...
module  {
  func @vec_task_0(%arg0: memref<?x6xf32>, %arg1: memref<1x?xf32>) {
    ...
    scf.for %arg2 = %c0_0 to %2 step %c4_1 {
      ...
      %11 = "lo_spn.histogram"(%5) {bucketCount = 2 : ui32, buckets = [#hi_spn.bucket<0 to 1 = 2.500000e-01>, #hi_spn.bucket<1 to 2 = 7.500000e-01>], supportMarginal = false, vector_width = 8 : i32} : (f32) -> !lo_spn.log<f32>
      %12 = "lo_spn.histogram"(%6) {bucketCount = 2 : ui32, buckets = [#hi_spn.bucket<0 to 1 = 4.500000e-01>, #hi_spn.bucket<1 to 2 = 5.500000e-01>], supportMarginal = false, vector_width = 8 : i32} : (f32) -> !lo_spn.log<f32>
    ...
    scf.for %arg2 = %2 to %0 step %c1 {
      ...
      %11 = "lo_spn.histogram"(%5) {bucketCount = 2 : ui32, buckets = [#hi_spn.bucket<0 to 1 = 2.500000e-01>, #hi_spn.bucket<1 to 2 = 7.500000e-01>], supportMarginal = false} : (f32) -> !lo_spn.log<f32>
      %12 = "lo_spn.histogram"(%6) {bucketCount = 2 : ui32, buckets = [#hi_spn.bucket<0 to 1 = 4.500000e-01>, #hi_spn.bucket<1 to 2 = 5.500000e-01>], supportMarginal = false} : (f32) -> !lo_spn.log<f32>

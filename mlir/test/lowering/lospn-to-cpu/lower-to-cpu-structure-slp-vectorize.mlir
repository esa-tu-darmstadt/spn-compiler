  ...
  ^bb0(%arg0: memref<?x4xi32>, %arg1: memref<1x?xf64>):  // no predecessors
    ...
    ^bb0(%arg2: index, %arg3: memref<?x4xi32>, %arg4: memref<1x?xf64>):  // no predecessors
      ...
      ^bb0(%arg9: i32, %arg10: i32, %arg11: i32, %arg12: i32):  // no predecessors
        ...
        %l1 = "lo_spn.arith.constant"() {type = f64, value = 1.0 : f64} : () -> f64
        %l2 = "lo_spn.arith.constant"() {type = f64, value = 2.0 : f64} : () -> f64
        %l3 = "lo_spn.arith.constant"() {type = f64, value = 3.0 : f64} : () -> f64
        %l4 = "lo_spn.arith.constant"() {type = f64, value = 4.0 : f64} : () -> f64

...
module  {
  ...
  ^bb0(%arg0: memref<?x4xi32>, %arg1: memref<1x?xf64>):  // no predecessors
    ...
    ^bb0(%arg2: index, %arg3: memref<?x4xi32>, %arg4: memref<1x?xf64>):  // no predecessors
      ...
      %6 = "lo_spn.batch_read"(%arg3, %arg2) {staticIndex = 1 : ui32} : (memref<?x4xi32>, index) -> i32
      %7 = "lo_spn.batch_read"(%arg3, %arg2) {staticIndex = 0 : ui32} : (memref<?x4xi32>, index) -> i32
    ...
    "lo_spn.return"() : () -> ()
  }) {sym_name = "spn_kernel", type = (memref<?x4xi32>, memref<1x?xf64>) -> ()} : () -> ()
}
...
// CHECK:           %[[VAL_2:.*]] = constant 3 : i32
// CHECK:           %[[VAL_3:.*]] = constant 2 : i32
// CHECK:           %[[VAL_4:.*]] = constant 1 : i32
// CHECK:           %[[VAL_5:.*]] = constant 0 : i32
// CHECK:           %[[VAL_6:.*]] = constant dense<[2.500000e-01, 2.500000e-01, 2.500000e-01, 5.000000e+00]> : vector<4xf64>
// CHECK:           %[[VAL_7:.*]] = constant dense<[4.000000e+00, 3.000000e+00, 6.000000e+00, 2.500000e-01]> : vector<4xf64>
// CHECK:           %[[VAL_8:.*]] = constant dense<[8.000000e+00, 7.000000e+00, 2.000000e+00, 1.000000e+00]> : vector<4xf64>
// CHECK:           %[[VAL_9:.*]] = constant dense<[0.62665706865775006, 1.2533141373155001, 1.8799712059732503, 2.5066282746310002]> : vector<4xf64>
// CHECK:           %[[VAL_10:.*]] = constant dense<[-1.250000e-01, -5.000000e-01, -1.125000e+00, -2.000000e+00]> : vector<4xf64>
// CHECK:           %[[VAL_11:.*]] = constant dense<[1.400000e-01, 1.300000e-01, 1.200000e-01, 1.100000e-01]> : vector<4xf64>
...
// CHECK:           %[[VAL_16:.*]] = subf %[[VAL_15]], %[[VAL_11]] : vector<4xf64>
// CHECK:           %[[VAL_17:.*]] = mulf %[[VAL_16]], %[[VAL_16]] : vector<4xf64>
...
// CHECK:           %[[VAL_21:.*]] = mulf %[[VAL_20]], %[[VAL_8]] : vector<4xf64>
// CHECK:           %[[VAL_22:.*]] = mulf %[[VAL_21]], %[[VAL_7]] : vector<4xf64>
// CHECK:           %[[VAL_23:.*]] = mulf %[[VAL_22]], %[[VAL_6]] : vector<4xf64>

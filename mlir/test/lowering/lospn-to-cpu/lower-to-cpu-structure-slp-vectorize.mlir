...
// CHECK:           %[[VAL_12:.*]] = arith.constant dense<0> : vector<4xi32>
// CHECK:           %[[VAL_13:.*]] = arith.constant dense<true> : vector<4xi1>
// CHECK:           %[[VAL_14:.*]] = arith.constant dense<[1, 0, 2, 3]> : vector<4xi32>
// CHECK:           %[[VAL_15:.*]] = arith.constant 0 : index
// CHECK:           %[[VAL_16:.*]] = vector.gather %[[VAL_0]]{{\[}}%[[VAL_15]], %[[VAL_15]]] {{\[}}%[[VAL_14]]], %[[VAL_13]], %[[VAL_12]] : memref<?x4xi32>, vector<4xi32>, vector<4xi1>, vector<4xi32> into vector<4xi32>
// CHECK:           %[[VAL_17:.*]] = arith.uitofp %[[VAL_16]] : vector<4xi32> to vector<4xf64>
// CHECK:           %[[VAL_18:.*]] = arith.subf %[[VAL_17]], %[[VAL_11]] : vector<4xf64>
// CHECK:           %[[VAL_19:.*]] = arith.mulf %[[VAL_18]], %[[VAL_18]] : vector<4xf64>
// CHECK:           %[[VAL_20:.*]] = arith.divf %[[VAL_19]], %[[VAL_10]] : vector<4xf64>
// CHECK:           %[[VAL_21:.*]] = math.exp %[[VAL_20]] : vector<4xf64>
// CHECK:           %[[VAL_22:.*]] = arith.divf %[[VAL_21]], %[[VAL_9]] : vector<4xf64>
// CHECK:           %[[VAL_23:.*]] = arith.mulf %[[VAL_8]], %[[VAL_22]] : vector<4xf64>
// CHECK:           %[[VAL_24:.*]] = arith.mulf %[[VAL_23]], %[[VAL_7]] : vector<4xf64>
// CHECK:           %[[VAL_25:.*]] = arith.mulf %[[VAL_24]], %[[VAL_6]] : vector<4xf64>
// CHECK:           %[[VAL_26:.*]] = vector.extractelement %[[VAL_25]]{{\[}}%[[VAL_2]] : i32] : vector<4xf64>
// CHECK:           %[[VAL_27:.*]] = vector.extractelement %[[VAL_25]]{{\[}}%[[VAL_3]] : i32] : vector<4xf64>
// CHECK:           %[[VAL_28:.*]] = vector.extractelement %[[VAL_25]]{{\[}}%[[VAL_4]] : i32] : vector<4xf64>
// CHECK:           %[[VAL_29:.*]] = vector.extractelement %[[VAL_25]]{{\[}}%[[VAL_5]] : i32] : vector<4xf64>
// CHECK:           %[[VAL_30:.*]] = "lo_spn.add"(%[[VAL_26]], %[[VAL_27]]) : (f64, f64) -> f64
// CHECK:           %[[VAL_31:.*]] = "lo_spn.add"(%[[VAL_28]], %[[VAL_29]]) : (f64, f64) -> f64
// CHECK:           %[[VAL_32:.*]] = "lo_spn.add"(%[[VAL_30]], %[[VAL_31]]) : (f64, f64) -> f64
// CHECK:           %[[VAL_33:.*]] = "lo_spn.log"(%[[VAL_32]]) : (f64) -> f64
// CHECK:           "lo_spn.batch_write"(%[[VAL_1]], %[[VAL_15]], %[[VAL_33]]) {transposed = true} : (memref<1x?xf64>, index, f64) -> ()
// CHECK:           "lo_spn.return"() : () -> ()
// CHECK:         }

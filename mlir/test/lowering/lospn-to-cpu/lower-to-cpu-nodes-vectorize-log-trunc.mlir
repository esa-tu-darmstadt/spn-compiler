...
module  {
  func @vec_task_0(%arg0: memref<?x4xf64>, %arg1: memref<1x?xf32>) {
    %c0 = constant 0 : index
    ...
    scf.for %arg2 = %c0_0 to %2 step %c8_1 {
      %3 = "lo_spn.batch_read"(%arg0, %arg2) {staticIndex = 0 : ui32, vector_width = 8 : i32} : (memref<?x4xf64>, index) -> f64
      %4 = "lo_spn.batch_read"(%arg0, %arg2) {staticIndex = 1 : ui32, vector_width = 8 : i32} : (memref<?x4xf64>, index) -> f64
      %5 = "lo_spn.batch_read"(%arg0, %arg2) {staticIndex = 2 : ui32, vector_width = 8 : i32} : (memref<?x4xf64>, index) -> f64
      %6 = "lo_spn.batch_read"(%arg0, %arg2) {staticIndex = 3 : ui32, vector_width = 8 : i32} : (memref<?x4xf64>, index) -> f64
      ...
      "lo_spn.batch_write"(%arg1, %arg2, %19) {vector_width = 8 : i32, transposed = true} : (memref<1x?xf32>, index, f32) -> ()
    }
    %c1 = constant 1 : index
    scf.for %arg2 = %2 to %0 step %c1 {
      %3 = "lo_spn.batch_read"(%arg0, %arg2) {staticIndex = 0 : ui32} : (memref<?x4xf64>, index) -> f64
      %4 = "lo_spn.batch_read"(%arg0, %arg2) {staticIndex = 1 : ui32} : (memref<?x4xf64>, index) -> f64
      %5 = "lo_spn.batch_read"(%arg0, %arg2) {staticIndex = 2 : ui32} : (memref<?x4xf64>, index) -> f64
      %6 = "lo_spn.batch_read"(%arg0, %arg2) {staticIndex = 3 : ui32} : (memref<?x4xf64>, index) -> f64
      ...
      "lo_spn.batch_write"(%arg1, %arg2, %19) {transposed = true} : (memref<1x?xf32>, index, f32) -> ()
    }
    return
  }
  func @spn_vector(%arg0: memref<?x4xf64>, %arg1: memref<1x?xf32>) {
...
// CHECK:             %[[VAL_131:.*]] = "lo_spn.batch_read"(%[[VAL_0]], %[[VAL_130]]) {staticIndex = 0 : ui32} : (memref<?x4xf64>, index) -> f64
// CHECK:             %[[VAL_132:.*]] = "lo_spn.batch_read"(%[[VAL_0]], %[[VAL_130]]) {staticIndex = 1 : ui32} : (memref<?x4xf64>, index) -> f64
// CHECK:             %[[VAL_133:.*]] = "lo_spn.batch_read"(%[[VAL_0]], %[[VAL_130]]) {staticIndex = 2 : ui32} : (memref<?x4xf64>, index) -> f64
// CHECK:             %[[VAL_134:.*]] = "lo_spn.batch_read"(%[[VAL_0]], %[[VAL_130]]) {staticIndex = 3 : ui32} : (memref<?x4xf64>, index) -> f64
// CHECK:             %[[VAL_135:.*]] = "lo_spn.gaussian"(%[[VAL_131]]) {mean = 1.100000e-01 : f64, stddev = 1.000000e+00 : f64, supportMarginal = false} : (f64) -> !lo_spn.log<f32>
...
// CHECK:             %[[VAL_143:.*]] = "lo_spn.mul"(%[[VAL_137]], %[[VAL_139]]) : (!lo_spn.log<f32>, !lo_spn.log<f32>) -> !lo_spn.log<f32>
// CHECK:             %[[VAL_144:.*]] = "lo_spn.mul"(%[[VAL_138]], %[[VAL_139]]) : (!lo_spn.log<f32>, !lo_spn.log<f32>) -> !lo_spn.log<f32>
// CHECK:             %[[VAL_145:.*]] = "lo_spn.add"(%[[VAL_143]], %[[VAL_144]]) : (!lo_spn.log<f32>, !lo_spn.log<f32>) -> !lo_spn.log<f32>
// CHECK:             %[[VAL_146:.*]] = "lo_spn.add"(%[[VAL_142]], %[[VAL_145]]) : (!lo_spn.log<f32>, !lo_spn.log<f32>) -> !lo_spn.log<f32>
// CHECK:             %[[VAL_147:.*]] = "lo_spn.strip_log"(%[[VAL_146]]) {target = f32} : (!lo_spn.log<f32>) -> f32
// CHECK:             "lo_spn.batch_write"(%[[VAL_1]], %[[VAL_130]], %[[VAL_147]]) {transposed = true} : (memref<1x?xf32>, index, f32) -> ()
// CHECK:           }
// CHECK:           return
// CHECK:         }

// RUN: %optcall --convert-math-to-llvm --finalize-memref-to-llvm --convert-arith-to-llvm --convert-func-to-llvm --convert-cf-to-llvm --convert-vector-to-llvm %s | FileCheck %s

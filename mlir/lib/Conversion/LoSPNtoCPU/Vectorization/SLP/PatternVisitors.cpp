...
void PatternVisitor::visit(BroadcastInsertSuperword const *pattern,
                           Superword const *superword) {
  visitDefault(pattern, superword);
}

void PatternVisitor::visit(ShuffleTwoSuperwords const *pattern,
                           Superword const *superword) {
  visitDefault(pattern, superword);
}
...
void PatternVisitor::visit(VectorizeAdd const *pattern,
                           Superword const *superword) {
  visitDefault(pattern, superword);
}

void PatternVisitor::visit(VectorizeMul const *pattern,
                           Superword const *superword) {
  visitDefault(pattern, superword);
}

void PatternVisitor::visit(VectorizeGaussian const *pattern,
                           Superword const *superword) {
  visitDefault(pattern, superword);
}

void PatternVisitor::visit(VectorizeLogAdd const *pattern,
                           Superword const *superword) {
  visitDefault(pattern, superword);
}

void PatternVisitor::visit(VectorizeLogMul const *pattern,
                           Superword const *superword) {
  visitDefault(pattern, superword);
}

void PatternVisitor::visit(VectorizeLogGaussian const *pattern,
                           Superword const *superword) {
  visitDefault(pattern, superword);
}
...
void LeafPatternVisitor::visit(BroadcastInsertSuperword const *pattern,
                               Superword const *superword) {
  SmallPtrSet<Value, 4> uniqueValues{std::begin(*superword),
                                     std::end(*superword)};

    ...
    namespace low {
      ...
      public:
        ...
        LogicalResult matchAndRewrite(UnOp op, PatternRewriter& rewriter) const override {
          ...
          func::FuncOp replaceFunc = module.template lookupSymbol<func::FuncOp>(funcName.value());
          if (!replaceFunc) {
      ...
      protected:
        ...
        virtual std::optional<StringRef> getReplacementFunction(VectorType vecTy) const = 0;
      ...
      protected:
        std::optional<StringRef> getReplacementFunction(VectorType vecTy) const override {
      ...
      struct ReplaceARMOptimizedRoutines : public impl::ReplaceARMOptimizedRoutinesBase<ReplaceARMOptimizedRoutines> {

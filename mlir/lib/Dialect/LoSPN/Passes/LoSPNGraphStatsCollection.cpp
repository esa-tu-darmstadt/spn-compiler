...
protected:
  void runOnOperation() override {
    // This pass does not perform transformations; no analysis will be
    // invalidated.
    ...
    auto featureCount =
        (!spn_body_bb.empty()) ? spn_body_bb.front()->getNumOperands() : -1;
    ...
    root->emitRemark("LoSPN graph statistics collection done.")

...
add_vertex_recursive(SPNGraph &graph, Operation *op,
                     std::unordered_map<Operation *, SPNGraph::vertex_descriptor> &mapping, const spnc::TargetExecutionModel &targetModel) {
...
GraphPartitioner::GraphPartitioner(llvm::ArrayRef<mlir::Operation *> rootNodes, const spnc::TargetExecutionModel &targetModel, size_t maxTaskSize)

...
module ram_data_combMem(	// src/main/scala/chisel3/util/Decoupled.scala:273:95
  input  [5:0]  R0_addr,
  input         R0_en,
                R0_clk,
  input  [5:0]  W0_addr,
  ...
  reg  [39:0] Memory[0:53];	// src/main/scala/chisel3/util/Decoupled.scala:273:95
  wire [39:0] _GEN;	// src/main/scala/chisel3/util/Decoupled.scala:273:95
  ...
  `ifndef SYNTHESIS	// src/main/scala/chisel3/util/Decoupled.scala:273:95
    `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Decoupled.scala:273:95
      ...
      reg [63:0] _RANDOM_MEM;	// src/main/scala/chisel3/util/Decoupled.scala:273:95
    `endif // RANDOMIZE_MEM_INIT
    ...
    initial begin	// src/main/scala/chisel3/util/Decoupled.scala:273:95
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Decoupled.scala:273:95
        for (initvar = 0; initvar < 54; initvar = initvar + 1) begin
          _RANDOM_MEM = {{`RANDOM}, {`RANDOM}};
          Memory[initvar] = _RANDOM_MEM[39:0];
  ...
  assign R0_data = R0_en ? _GEN : 40'bx;	// src/main/scala/chisel3/util/Decoupled.scala:273:95
endmodule

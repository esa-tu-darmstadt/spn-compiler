...
def test_cpu_histogram():
    ...
    h1 = Histogram([0., 1., 3.], [0.25, 0.75], [1, 1], scope=0)
    h2 = Histogram([0., 1., 3.], [0.45, 0.55], [1, 1], scope=1)
    h3 = Histogram([0., 1., 3.], [0.33, 0.67], [1, 1], scope=0)
    h4 = Histogram([0., 1., 3.], [0.875, 0.125], [1, 1], scope=1)

...
def test_vector_slp_escaping_users():
    ...
    h0 = Histogram([0.0, 1.0, 2.0], [0.1, 0.9], [1, 1], scope=12)
    h1 = Histogram([0.0, 1.0, 2.0], [0.2, 0.8], [1, 1], scope=13)
    h2 = Histogram([0.0, 1.0, 2.0], [0.3, 0.7], [1, 1], scope=14)
    h3 = Histogram([0.0, 1.0, 2.0], [0.4, 0.6], [1, 1], scope=15)
    h4 = Histogram([0.0, 1.0, 2.0], [0.5, 0.5], [1, 1], scope=16)
    h5 = Histogram([0.0, 1.0, 2.0], [0.6, 0.4], [1, 1], scope=17)
    h6 = Histogram([0.0, 1.0, 2.0], [0.7, 0.3], [1, 1], scope=18)
    h7 = Histogram([0.0, 1.0, 2.0], [0.8, 0.2], [1, 1], scope=19)
